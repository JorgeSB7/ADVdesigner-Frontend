...
export class SeemagicPage implements OnInit {
  ...
  loreRazas() {
    this.aux = this.magic.typem;
    if (this.aux == "Abjuración") {
    ...
    } else if (this.aux == "Encantamiento") {
    ...
    } else if (this.aux == "Transmutación") {
